    ...
    <div className="flex min-h-screen" style={{ background: 'var(--color-bg)' }}>
      ...
      >
                ...
                return (
                  <motion.div key={item.to} variants={itemVariants} className="relative">
                    ...
                    <Link
                      to={item.to}
                      onClick={() => setSidebarOpen(false)}
                      className="flex items-center gap-3 px-3 py-[9px] text-[14px] font-medium transition-colors duration-150"
                      style={{
        ...
        <div className="p-3 flex-shrink-0" style={{ borderTop: '1px solid var(--color-border-light)' }}>
          <div className="flex items-center gap-3 px-2.5 py-2 transition-colors group cursor-default"
      ...
      <main className="flex-1 lg:ml-[260px] min-h-screen flex flex-col">
        ...
        {/* Top bar */}
        <header className="sticky top-0 z-30 h-[56px] flex items-center justify-between px-5 gap-4"
          style={{
            background: 'var(--color-bg-card)',
