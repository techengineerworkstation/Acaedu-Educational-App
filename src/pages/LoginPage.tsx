    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <motion.div initial={{opacity:0,scale:0.95}} animate={{opacity:1,scale:1}} className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold" style={{background:'var(--gradient-mixed)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent'}}>Welcome back</h1>
        ...
        <div className="space-y-3">
          <button onClick={handleGoogle} className="w-full py-3 rounded-lg border-2 border-border font-semibold text-sm flex items-center justify-center gap-2 hover:border-primary hover:text-primary transition">
          ...
          <button onClick={handleApple} className="w-full py-3 rounded-lg border-2 border-border font-semibold text-sm flex items-center justify-center gap-2 hover:border-primary hover:text-primary transition">
